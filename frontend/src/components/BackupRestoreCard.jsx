  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button type="button" onClick={runRestore} disabled={Boolean(loading) || confirmation !== 'RESTAURAR BACKUP'} className="inline-flex items-center rounded-md bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-700 disabled:opacity-50">
