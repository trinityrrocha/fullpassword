...
assert.match(panel, /canInstallUpdate\(status\) && <button/);
assert.match(panel, /changes_truncated/);
assert.match(panel, /status.changes.map/);
assert.match(panel, /Mostrando as 100 alterações mais recentes/);
